    ...
    <body>
       ...
       <!-- Page Content -->
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="text-align:center">Different Causes Based Accident Rates Graphical View</h1>


                    <img src="img/different_fault.jpg" class="img-rounded" alt="Cinque Terre" width="100%" height="400" align="middle">
