    ...
    <body>
       ...
       <div class="container">
          ...
          $id = $_GET['id'];
           ...
           $sql = "SELECT * FROM monthly_analysis WHERE id=$id";
          ...
          if ($res) {
           $data =mysql_fetch_assoc($res);
            ...
            ?>
                 ...
                 <form method="post" action="update_m.php?id=<?php echo $data['id'] ?>"><br>
                   ...
                   <input type="text"name="month" value="<?php echo $data['month'] ?>" required="required"/>
                   </div>
