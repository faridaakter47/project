...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header" style="text-align:center">The High Risky Roads In Bangladesh</h1>
            ...
            <div class="row">
                ...
                <!-- Content Column -->
                 ...
                 <form method="POST" action="r_search.php">
                    <input class="btn btn-md btn-default btn-block" style="float: right;width:20%;margin-bottom:10px" type="text" name="high_risk_road_name" placeholder="Search Road" >
                </form>
                 <?php 
                ...
                <table border="1" width="100%">
                    <thead>
                        <tr>
                            <th style="text-align:center">High Risk Roads</th>
                            <th style="text-align:center"> Yearly Accident Rate</th>
                            <th style="text-align:center">Per day Accident Occur</th>
                    ...
                    <tbody>
                        <?php
                              ...
                              $sql = "SELECT*FROM  road_analysis LIMIT $page1,8 ";

                              $res = mysql_query($sql) or die(mysql_error());

                         while ($data = mysql_fetch_assoc($res)) { ?>
                            <tr style="text-align:center">
                                <td><?php echo $data['high_risk_road_name'] ?></td>
                               
                                <td><?php echo $data['yearly_accident_rate'] ?></td>

                                <td><?php echo $data['per_day'] ?></td>

                                <?php if(isset($_SESSION['user']) && $_SESSION['user']['username'] =='farida') { ?>
                                        <td>
                                            <a href="r_update.php?id=<?php echo $data['id']; ?>" style="color:black">Update</a>
                                        </td>
                                        
                                        <td>
                                            <a href="r_delete.php?id=<?php echo $data['id']; ?>" style="color:black">Delete</a>
                                        </td>
                   ...
                   echo "Page";
                    ...
                    for($b=1;$b<=$a;$b++)
                     ...
                     ?> <a href="high_risk_roads.php?page=<?php echo $b;?>" style="margin-right:5px;color:black"><?php echo $b; ?></a> <?php
                    ...
                    <h2 style="text-align:center;margin-top:5px">Graphical view</h2><a class="btn btn-sm btn-default btn-block" href="high_risk_road_view.php" style="margin-left:295px;width:30%">CLICK HERE</a>
