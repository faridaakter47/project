...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="text-align:center">Yearly Accident Rates In bangladesh</h1>
            ...
            <div class="row">
                ...
                <!-- Content Column -->
                 <div class="col-md-9">
                  <form method="POST" action="y_search.php">
                ...
                <table border="1" width="100%">
                    ...
                    <tbody>
                        ...
                        <?php 
                              $sql = "SELECT * FROM yearly_analysis LIMIT $page1,10";
                              $res = mysql_query($sql) or die(mysql_error());

                            while ($data = mysql_fetch_assoc($res)) { ?>
                            <tr style="text-align:center">
                                <th style="text-align:center"><?php echo $data['year'] ?></th>
                                <th style="text-align:center"><?php echo $data['accident_rate'] ?></th>
                                <th style="text-align:center"><?php echo $data['number_of_death'] ?></th>
                                <th style="text-align:center"><?php echo $data['number_of_injured'] ?></th>
                                <?php if(isset($_SESSION['user']) && $_SESSION['user']['username'] =='farida') { ?>
                                        <td>
                                            <a href="y_update.php?id=<?php echo $data['id']; ?>" style="color:black">Update</a>
                                        </td>
                                        
                                        <td>
                                            <a href="y_delete.php?id=<?php echo $data['id']; ?>" style="color:black">Delete</a>
                                        </td>
                    ...
                    for($b=1;$b<=$a;$b++)
                     ...
                     ?> <a href="yearly_rates.php?page=<?php echo $b;?>" style="margin-right:5px;color:black"><?php echo $b; ?></a> <?php

                      }
                     ?>
           
                <h2 style="text-align:center;margin-top:5px">Graphical view</h2><a class="btn btn-sm btn-default btn-block" href="yearly_view.php" style="margin-left:295px;width:30%">CLICK HERE</a>
