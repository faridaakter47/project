...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="text-align:center">Accident Statistics</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <p style="font-family:Times New Roman;font-size:18px;text-align:justify">Bangladesh has a very high road accident fatality rate. Last  three years the number
                     of death person about 15,726 and the number of injured person  about 22,192. Everyday around eight persons die in road accidents. 
                     According to recent news of "Daily Prothom Alo", below image  can be realize the severeness of accident in Bangladesh comparatively other country.
                     <br><img src="img/accident_statistics.png" style="width:100%;height:700px">
